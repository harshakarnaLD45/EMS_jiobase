...
import { Plus, Calendar, Clock, TrendingUp, LineChart, Clock4, Users, FileText, AlertTriangle, X } from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';
import { adminApi, employeeApi, timesheetApi, leaveApi, timesheetComplianceApi } from '../../utils/supabase';
    ...
    try {
      ...
      if (isAdmin()) {
        ...
        try {
          ...
          // Don't block dashboard loading for compliance errors
        }
      }
      ...
      <div className="content-grid gap-6 w-full max-w-full">
        <div className="recent-timesheets stats-card w-full">
          <div className=" recent-timesheets-card w-full ">
            ...
            {/* Timesheet Warning Banner - Shows when yesterday's timesheet is missing */}
